...
$('#yes').click(function() {
    ...
    Swal.fire({
        ...
        width: 900,
        padding: '3em',
        html: "<input type='text' class='form-control' id='txtReason' onmousemove=textGenerate()  placeholder='Chó là bạn, Còn bạn thì sao???'>",
        background: '#fff url("img/iput-bg.jpg")',
        backdrop: `
              rgba(0,0,123,0.4)
              url("img/pepedance.gif")
              left top
              no-repeat
            `,
